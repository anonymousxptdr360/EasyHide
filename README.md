...
I will release an update soon to explain how to use it for specific cases, since every situation is different.
Originally, this code was made to save ink by hiding ads on shipping labels, similar to what Vinted offers, but in a much easier way.
